...
const CategoryPage = ({ postsData, postCategories }) => {
    const [isOpen, setIsOpen] = useState(true)

    return (
        <div className="container mx-auto md:max-w-screen-xl">
            <div className="grid gap-4 md:grid-cols-12 min-h-screen md:grid-rows-[80px_minmax(300px,_1fr)] pt-8">
                ...
                <div className="flex md:hidden gap-x-4 overflow-x-auto pb-4">
